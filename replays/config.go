...
// GetInstallDir returns the replays installation directory
func GetInstallDir() string {
	return getInstallDir()
}

// InitEnv creates or loads env.properties in the replays install directory
func InitEnv() error {
	log.Println("Initializing replays environment")
