...
func printUsage() {
	...
	fmt.Println("  controlpanel <instance-name> --owlcms [version|latest|previous|stop|list]")
	fmt.Println("  controlpanel <instance-name> --tracker [version|latest|previous|stop|list]")
	fmt.Println("  controlpanel [--instance-dir <name-or-path>] --owlcms [version|latest|previous|stop|list]")
	fmt.Println("  controlpanel [--instance-dir <name-or-path>] --tracker [version|latest|previous|stop|list]")
	fmt.Println("")
	fmt.Println("Options:")
	...
	fmt.Println("  --owlcms [value]                Start/stop/list OWLCMS headlessly (default: previous, then latest)")
	fmt.Println("                                  If omitted, value defaults to previous (falls back to latest)")
	fmt.Println("  --tracker [value]               Start/stop/list Tracker headlessly (default: previous, then latest)")
	fmt.Println("                                  If omitted, value defaults to previous (falls back to latest)")
